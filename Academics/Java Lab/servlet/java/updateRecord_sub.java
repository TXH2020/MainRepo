...
import java.sql.*;
@WebServlet("/updateRecord_sub")
public class updateRecord_sub extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(flag==1)
		    ...
		    try { 
		        ...
		        String query = "update library set ID=?,Name=?,Author=?,Edition=?,Price=? where ID=?";
		        ...
		        ps.setInt(6, uid);
		        ps.executeUpdate();
		        out.println("Successfully updated details as follows:");
