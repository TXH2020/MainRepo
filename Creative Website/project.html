...
top:152px;}
	...
	<h3 >
		...
		<div class="box2"><font face=>	<a href="#">HOME</a>&nbsp;&nbsp;&nbsp;
			...
			<a href="contacts.html">CONTACT US</a></span>
		</font></div>
	</h3><br><br>
<head>
...
<p>		<b>Gender:</b>
 ...
 <p>
               <b> <label for="city">City/Village/Town:</label></b>
                <input type="text"   name="city/village/town"  id="city"><br>
...
<p>
              <b> <label for="emailAddress">Aadhar Number:</label></b>
                <input type="tel" name="email" id="emailAddress" placeholder="12 digit number"><br>
...
<div class="box6"><marquee direction="right"  width="60%" height="60%">
