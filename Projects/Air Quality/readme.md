This program predicts Air Quality Index for three days based on the air pollution data(....36.xlsx). We then check the quality of predictions by comparing it with the actual data(....501.xlsx).
